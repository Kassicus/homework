...
def search_suggestions():
    ...
    try:
        ...
        for term in common_terms:
            if query.lower() in term.lower() and term not in [
...
def quick_search():
    ...
    try:
            ...
            results.append(
                {
                    ...
                    "description": contract.description[:100] + "..."
                    if len(contract.description) > 100
        ...
        return jsonify({"results": [], "error": "Failed to perform quick search"}), 500
